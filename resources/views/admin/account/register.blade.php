              ...
              <div class="card-body">
                  <form method="POST" action="{{ route('register') }}">
                      ...
                      <div class="form-group row">
                          <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Fullname') }}</label>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password_confirmation" autocomplete="current-password">
                      ...
                      <div class="form-group row mb-0">
                          <div class="col-md-8 offset-md-4">
                            ...
                            <a type="button" class="btn btn-primary" href="{{url('login')}}" >{{ __('Login') }}</a>
